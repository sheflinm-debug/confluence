...
public static class EraTimeline
{
    ...
    public static readonly EraPhase[] Phases =
    {
        ...
        new EraPhase(Abiotic, "Condensation & water arrival", 5f, 4_200_000_000f, 4_000_000_000f),
        ...
        // These sub-phases run as a caption/clock OVERLAY on top of the live colony
        // simulation that GenesisCinematic hands off to - they are NOT yet separately
        ...
        new EraPhase(Era1, "Cambrian Explosion", 45f, 600_000_000f, 540_000_000f),
    };
